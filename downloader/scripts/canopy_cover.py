...
# -*- coding: utf-8 -*-
"""
Download LANDFIRE canopy cover (CC).
...
# ===== USER SETTINGS =====
VERSION = os.environ.get("LANDFIRE_CC_VERSION", "LF2024")
OUTPUT_DIR = "/home/runyang/ryang/LANDFIRE_FUELS_2024/CC"
URLS = {
    "LF2024": "https://landfire.gov/data-downloads/CONUS_LF2024/LF2024_CC_CONUS.zip",
}
...
def main():
    parser = argparse.ArgumentParser(description="Download LANDFIRE canopy cover.")
    ...
    with requests.Session() as session:
        session.headers["User-Agent"] = "firemap-landfire-cc/1.0"
