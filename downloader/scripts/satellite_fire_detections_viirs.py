...
SOURCES = {
    ...
    'VIIRS_S_NPP_SP': 'VIIRS_SNPP_SP',
    'VIIRS_S_NPP_URT_NRT': 'VIIRS_SNPP_NRT',
}
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Download FIRMS VIIRS CSV files.')
    ...
    with requests.Session() as session:
        session.headers['User-Agent'] = 'firemap-viirs-downloader/1.0'
