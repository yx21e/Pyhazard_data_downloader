...
# -*- coding: utf-8 -*-
"""
Download LANDFIRE surface fuels (FBFM40).

Usage:
    python surface_fuels.py
    python surface_fuels.py --version LF2024
"""
...
def main():
    parser = argparse.ArgumentParser(description="Download LANDFIRE FBFM40.")
    ...
    with requests.Session() as session:
        session.headers["User-Agent"] = "firemap-landfire-fbfm40/1.0"
